...
import { Bricolage_Grotesque, Outfit, Playfair_Display } from "next/font/google";
...
// Reduced font weights to avoid Cloudflare Worker resource limits (Error 1102).
...
// Playfair Display — elegant serif for league names and premium headings.
// Only 2 weights to keep the bundle small.
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" dir="ltr" suppressHydrationWarning>
      ...
      <body className={`${bricolage.variable} ${outfit.variable} ${playfair.variable} min-h-screen flex flex-col bg-cream text-night antialiased`}>
        <I18nProvider>
          <ToastProvider>
            <a
              href="#main-content"
