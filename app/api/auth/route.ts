...
// Preferred: set ADMIN_PASSWORD_HASH to a PBKDF2 hash produced by
// lib/session.ts's hashPassword() and this route verifies against it securely.
// Fallback: ADMIN_PASSWORD as plaintext (still compared with a timing-safe
// check, not `!==`, but a plaintext secret in the environment is weaker —
// migrate to ADMIN_PASSWORD_HASH before launch).
const ADMIN_PASSWORD_HASH = process.env.ADMIN_PASSWORD_HASH;
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || 'qawla2025';
