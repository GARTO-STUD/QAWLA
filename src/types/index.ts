...
export interface Article {
  seo?: { title: string; description: string; primaryKeyword: string; keywords: string[]; score: number; newsReadiness: number; recommendations: Array<{ priority: string; title: string; action: string }> };
  id: string;
  slug: string;
  title: string;
  subtitle?: string;
  ...
  html?: string;
  coverImage?: string;
  /** Image provenance: prefer the exact image supplied by the source article/feed. */
...
export type AgentName = 'scout' | 'factCheck' | 'analyst' | 'writer' | 'editor' | 'seo' | 'guardian';
