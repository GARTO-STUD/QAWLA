      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          {([
            ...
            <button
              ...
              className={cn(
                ...
                tab === t.id ? 'bg-pitch text-night' : 'bg-white border border-gray-200 text-night/70 hover:border-pitch/40',
              )}
            >
              {t.label}
            </button>
        ...
        {debounced.trim() === '' ? (
          ...
          <>
            ...
            <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6" stagger={0.08}>
              {hits.map((hit) => (
                <StaggerItem key={`${hit.type}-${hit.id}`}>
                  <Link
                    href={hit.url}
                    className="group flex flex-col card card-hover h-full"
                  >
                    ...
                    <div className="px-4 pb-4 flex-1">
                      <h3 className="heading-serif text-base sm:text-lg text-night leading-tight group-hover:text-pitch-dk transition-colors line-clamp-2">
