    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-20">
        ...
        <section aria-labelledby="form-heading" className="mb-14">
          <Reveal>
            <h2 id="form-heading" className="heading-serif text-2xl sm:text-3xl text-night mb-6">
              Send us a message
            </h2>
        ...
        <section aria-labelledby="faq-heading">
          <Reveal>
            <h2 id="faq-heading" className="heading-serif text-2xl sm:text-3xl text-night mb-6">
