...
export function applyPolicy(ctx: DecisionContext): ConfidenceResult['decision'] {
  ...
  // Transfers below 70: hold
  if (isTransfer && confidence.score < 70) return 'hold';
...
export function confidenceColor(score: number): { bg: string; text: string; border: string; ring: string } {
  if (score >= 85) return { bg: 'bg-emerald-100', text: 'text-emerald-700', border: 'border-emerald-200', ring: 'ring-emerald-500/20' };
  if (score >= 70) return { bg: 'bg-lime-100', text: 'text-lime-700', border: 'border-lime-200', ring: 'ring-lime-500/20' };
  if (score >= 55) return { bg: 'bg-amber-100', text: 'text-amber-700', border: 'border-amber-200', ring: 'ring-amber-500/20' };
  if (score >= 35) return { bg: 'bg-orange-100', text: 'text-orange-700', border: 'border-orange-200', ring: 'ring-orange-500/20' };
  return { bg: 'bg-red-100', text: 'text-red-700', border: 'border-red-200', ring: 'ring-red-500/20' };
}
