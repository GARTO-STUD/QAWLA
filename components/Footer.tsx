          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="mt-3 text-cream/70 text-sm sm:text-base max-w-md">
                Get the morning briefing — verified transfers, tactical analysis, and match coverage in your inbox.
              </p>
            </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div className="col-span-2">
            ...
            <p className="text-cream/60 text-sm leading-relaxed max-w-sm mb-6">
              Qawla is an independent football platform. Every story is verified through multi-source cross-referencing before publication — no rumors presented as facts.
            </p>
          ...
          {FOOTER_LINKS.map((section) => (
            <nav key={section.title} aria-label={section.title}>
              <h3 className="text-cream/90 text-sm font-bold uppercase tracking-wider mb-4">{section.title}</h3>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-cream/90 text-xs font-bold mb-0.5">Verified Sources</p>
              <p className="text-cream/40 text-xs leading-relaxed">Every story cross-referenced with multiple independent sources.</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-cream/90 text-xs font-bold mb-0.5">Independent & Reader-Funded</p>
              <p className="text-cream/40 text-xs leading-relaxed">No paywalls. No intrusive ads. Supported by readers.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-cream/40 text-xs text-center sm:text-left">
            © {new Date().getFullYear()} Qawla. All rights reserved. Independent platform — not affiliated with any football club, federation, or league.
          </p>
          <div className="flex items-center gap-4 text-xs text-cream/40">
            <Link href="/privacy" className="hover:text-cream/80 transition-colors">Privacy</Link>
            <Link href="/terms" className="hover:text-cream/80 transition-colors">Terms</Link>
          </div>
        </div>
      </div>
    </footer>
